...
json_chunks <- list.files(path = "data", pattern = "top_spenders_p_[0-9]+\\.json", full.names = TRUE)

# Specify which entities are removed from the coverage. Since they publish ads in more countries, the number of distinct regions overwhelms the API, which is still an unresolved issue on FB side.
